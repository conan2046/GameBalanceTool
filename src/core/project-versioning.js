...
export const PROJECT_VERSION = '3.10.1';
export const APP_VERSION_LABEL = `v${PROJECT_VERSION}`;
export const APP_RELEASE_NAME = '战斗配置布局修订版';
export const COMPATIBLE_IMPORTS = ['2.1', '3.0', '3.1', '3.2', '3.3', '3.4', '3.5', '3.6', '3.6.0', '3.7', '3.7.0', '3.7.1', '3.8.0', '3.8.1', '3.8.2', '3.9.0', '3.10.0', '3.10.1'];
