# GameBalanceTool V3.7.0 技术维护手册

## 1. 项目定位

GameBalanceTool V3.7.0 是游戏数值模拟平台，核心目标是把属性、职业、境界、装备、养成、经济、曲线、战斗、付费模拟、ROI、多方案工程统一到一个可导入导出的本地工具内。
...
docs/
  ...
  VERSION_HISTORY.md        V3.1 到 V3.7 版本历史
```
